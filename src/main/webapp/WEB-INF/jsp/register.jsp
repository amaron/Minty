...
<div class="container">
    ...
    <div class="row-fluid">
        ...
        <div class="span6">
            ...
            <form action="/user/register" method="post" class="well" id="registerHere">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <button type="submit" style="display:none" id ="regBtn" class="btn btn-success" >Create My Account</button>
                    </div>
                </div>
        ...
        Please Verify Captcha to enable Registration!
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            ...
                            if(result=="yes"){
                                ...
                                $('#regBtn').show();
                                check=true;
                                alert("you can register now!");
                            }
                            else{
                                alert("Please try again, or reload captcha to view a different image.");
                            }
